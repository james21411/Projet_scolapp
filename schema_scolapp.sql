...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `registered_schools`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `registered_schools` (
  ...
  `domain_prefix` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('active','inactive','suspended') COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `plan` enum('basic','premium','enterprise') COLLATE utf8mb4_unicode_ci DEFAULT 'basic',
