...
export default function LandingPage() {
    ...
    return (
        <div className="bg-edu-background text-edu-on-background font-roboto selection:bg-edu-primary/30 min-h-screen overflow-x-hidden">
            {/* TopNavBar - bg blanc solide sur mobile, semi-transparent sur desktop */}
            <nav className="fixed top-0 w-full z-50 bg-white border-b border-slate-100 shadow-sm md:bg-white/90 md:backdrop-blur-md">
                <div className="flex justify-between items-center h-16 px-4 md:px-12 max-w-7xl mx-auto">
                    ...
                    {/* CTA buttons - hidden on mobile to save space */}
                    ...
                    {/* Mobile: bouton connexion + hamburger */}
                    <div className="flex md:hidden items-center gap-2">
                        <Link href="/login">
                            <button className="px-4 py-2 bg-[#00288e] text-white font-bold text-sm hover:bg-[#1e40af] transition-all">Connexion</button>
                        </Link>
                        <button
                            onClick={() => setIsMenuOpen(!isMenuOpen)}
                            className="p-2 text-slate-700 hover:text-edu-primary transition-colors"
                            aria-label="Menu"
                        >
                            {isMenuOpen ? (
                ...
                {/* Mobile dropdown menu - fond blanc solide */}
                {isMenuOpen && (
                    <div className="md:hidden bg-white border-t border-slate-100 shadow-lg">
                        <div className="flex flex-col px-4 py-4 space-y-4">
                            <a className="text-sm font-semibold text-slate-700 hover:text-edu-primary transition-colors py-2 border-b border-slate-100" href="#fonctionnalites" onClick={() => setIsMenuOpen(false)}>Fonctionnalités</a>
                            <a className="text-sm font-semibold text-slate-700 hover:text-edu-primary transition-colors py-2 border-b border-slate-100" href="#solutions" onClick={() => setIsMenuOpen(false)}>Solutions</a>
                            <a className="text-sm font-semibold text-slate-700 hover:text-edu-primary transition-colors py-2 border-b border-slate-100" href="#tarifs" onClick={() => setIsMenuOpen(false)}>Tarifs</a>
                            <a className="text-sm font-semibold text-slate-700 hover:text-edu-primary transition-colors py-2" href="#apropos" onClick={() => setIsMenuOpen(false)}>À propos</a>
                            <Link href="/login" onClick={() => setIsMenuOpen(false)}>
                                <button className="w-full px-6 py-3 bg-[#3fd298] text-[#002113] font-bold hover:bg-[#34bc86] transition-all shadow-md">Essai Gratuit</button>
                            </Link>
                        </div>
                    </div>
                )}
